...
Future<Usuario> createUsuario(String nombre, String email, String password, String rol, String estado) async {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        ElevatedButton(
          onPressed: () {
            setState(() {
              _futureUsuario = createUsuario(_nombre.text,_email.text, _password.text, _rol.text, _estado.text);
            });
          },
